...
os.makedirs('src/main/java/com/cloudeagle/githubaccess/model', exist_ok=True)
...
with open('src/main/java/com/cloudeagle/githubaccess/model/GitHubRepo.java', 'w') as f:
    f.write('\n'.join(repo))
